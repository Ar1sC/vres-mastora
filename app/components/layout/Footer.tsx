    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">VresMastora</h3>
            <p className="text-gray-400">
              Connecting skilled professionals with customers in Greece.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/professionals" className="text-gray-400 hover:text-white">
                  Professionals
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8">
          <p className="text-center text-gray-400">
            © {new Date().getFullYear()} VresMastora. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
